  ...
  <div className="row">
    ...
    <div className="col-md-8">
      <div className="card-body">
        ...
        <button className='btn btn-darck' onClick={() => cantProducto("-")}>-</button>
        <button className='btn btn-dark' onClick={() => agregarProducto(producto, cantidad)}>Agregar al carrito <span>🛒</span></button>
      </div>
    </div>
  </div>
</div>
